...
살구다방, 서울.`,
        statement: `작품 활동과 함께, 서울과학기술대학교 타이포그래피 연구실에서 “타이포그래피의 의미와 구조”에 관한 연구를 진행하고 있다. 연구와 작업을 아우르는 주제는 ‘언어’와 ‘이미지’의 ‘관계’이다. 시각 예술은 항상 이미지로 존재하지만, 그 이미지는 세상에 보이는 순간부터 기호 구조를 거쳐 언어처럼 작동하게 된다. 초기 작업에선 이러한 원리에 의구심을 품고 이미지에서 언어를 떼어내 순수한 상태로 제시하려 하였다. 하지만 이미지가 인식되는 순간 자동 발생하는 언어적 개입을 차단할 순 없었다. 역설적으로, 이런 실패는 언어와 이미지의 불가분한 관계에 관한 호기심으로 이어졌다. 지금은 타이포그래피를 포함하여 언어의 시각화인 문자, 문자의 물질화인 활자 등에 주목하고 있다.`
    },
    drawing: [
