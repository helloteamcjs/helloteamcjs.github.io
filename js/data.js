...
살구다방, 서울.`,
        ...
        작품 활동과 함께, 서울과학기술대학교 타이포그래피 연구실에서 “타이포그래피의 의미와 구조”를 중심으로 연구하고 있다. 연구와 작업을 아우르는 주제는 ‘언어’와 ‘이미지’의 ‘관계’이다. 시각 예술은 항상 이미지로 존재하지만, 그 이미지는 세상에 보이는 순간부터 기호 구조를 거쳐 언어처럼 작동하게 된다. 작업의 초기엔 이 원리에 의구심을 품고, 작품에서 언어를 배제하고자 하였다. 그러나 작품, 즉 이미지가 인식되는 순간 자동 발생하는 언어적 개입을 차단할 순 없었다. 역설적이게도, 이 실패는 언어와 이미지의 불가분한 관계를 탐구하려는 호기심으로 이어졌다. 지금은 타이포그래피를 포함하여 언어의 시각화인 문자, 문자의 물질화인 활자 등에 주목하고 있다.`
    },
    drawing: [
    ...
    graphic: [
        ...
        { src: "images/graphic/kim-01.webp", caption: "김양숙, 金良淑, kimyangsook, 2026.", size: 2, break: true },
        ...
        { src: "images/graphic/woriginal.webp", caption: "(watcha original) 〈인사이드 리릭스〉, title design, 2022.", size: 1.5, break: true },
